"""
Keyboard.py: File to define Keyboard Model
"""
from app import db
...
relator = ManageRelationsDB('Keyboard')

class Keyboard(BaseDB, db.Model):
    """Defined class to Keyboard Model"""
    __tablename__ = relator.plural_name

    id = ManageFieldsDB.db_primary_key()
    type = ManageFieldsDB.db_string(100)
    switch = ManageFieldsDB.db_string(100, nullable=True)
