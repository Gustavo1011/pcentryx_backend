"""
kit_mouse_keyboard.py: File to define KitMouseKeyboard Model
"""
from app import db
...
relator = ManageRelationsDB('KitMouseKeyboard')

class KitMouseKeyboard(BaseDB, db.Model):
    """Defined class to KitMouseKeyboard Model"""
    __tablename__ = relator.plural_name

    id = ManageFieldsDB.db_primary_key()
    type_keyboard = ManageFieldsDB.db_string(100)
    output_keyboard = ManageFieldsDB.db_string(100)
    ...
    def get_response(self, **kwargs):
        ...
        entity = {
            "id": self.id,
            "type_keyboard": self.type_keyboard,
            "output_keyboard": self.output_keyboard,
