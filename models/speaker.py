"""
speaker.py: File to define Speaker Model
"""
from app import db
...
relator = ManageRelationsDB('Speaker')

class Speaker(BaseDB, db.Model):
    """Defined class to Speaker Model"""
    __tablename__ = relator.plural_name

    id = ManageFieldsDB.db_primary_key()
    subwoofer = ManageFieldsDB.db_string(50)
    satellite_speaker = ManageFieldsDB.db_string(50)
    ...
    def get_response(self, **kwargs):
        ...
        entity = {
            ...
            "satellite_speaker": self.satellite_speaker,
