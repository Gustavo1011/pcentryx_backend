"""
type_service.py: File to define TypeService Model
"""
from app import db
...
relator = ManageRelationsDB('TypeService')

class TypeService(BaseDB, db.Model):
    """Defined class to TypeService Model"""
    ...
    minimal_type_services = relator.has_many('MinimalTypeService')
